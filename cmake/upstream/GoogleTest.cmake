...
.. command:: gtest_add_tests
  ...
  ``CMD_WRAPPER arg1...``
    Any command wrapper to pass on the command line to each test case.
...
function(gtest_add_tests)
  ...
  foreach(source IN LISTS ARGS_SOURCES)
    ...
    foreach(hit ${found_tests})
      ...
      if (ARGS_CMD_WRAPPER)
        set(ctest_test_command ${ARGS_CMD_WRAPPER} $<TARGET_FILE:${ARGS_TARGET}>)
      else()
...
function(gtest_discover_tests TARGET)
  cmake_parse_arguments(
    ...
    "CMD_WRAPPER;EXTRA_ARGS;PROPERTIES;TEST_FILTER"
    ${ARGN}
  )
  ...
  if(_DISCOVERY_MODE STREQUAL "POST_BUILD")
    add_custom_command(
      ...
      COMMAND "${CMAKE_COMMAND}"
              ...
              -D "TEST_CMD_WRAPPER=${_CMD_WRAPPER}"
