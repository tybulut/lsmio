...
function(gtest_discover_tests_impl)
  ...
  cmake_parse_arguments(
    ...
    "TEST_CMD_WRAPPER;TEST_EXTRA_ARGS;TEST_PROPERTIES;TEST_EXECUTOR"
    ${ARGN}
  )

  set(prefix "${_TEST_PREFIX}")
  set(suffix "${_TEST_SUFFIX}")
  set(cmd_wrapper ${_TEST_CMD_WRAPPER})
  ...
  foreach(line ${output})
    ...
    if(NOT line MATCHES "gtest_main\\.cc")
      ...
      if(NOT line MATCHES "^  ")
        ...
        if (cmd_wrapper)
          set(TEST_COMMAND ${cmd_wrapper} "${_TEST_EXECUTABLE}")
        else()
          set(TEST_COMMAND "${_TEST_EXECUTABLE}")
        endif()
...
if(CMAKE_SCRIPT_MODE_FILE)
  gtest_discover_tests_impl(
    ...
    TEST_CMD_WRAPPER ${TEST_CMD_WRAPPER}
